...
<body>
  <h1><center><b><img src="icons/trainj.png"/>Train Ticket Booking &nbsp<img src="icons/tracks-intersections.png"/></center></b></h1>
...
<div class="container2">
  ...
  &nbsp
   ...
   <option>Deshnok</option>
   <option>Nokha</option>
   <option>Napasar</option>
   <option>Ratangarh</option>
   <option>Shri Dhungargarh</option> 
   </select>

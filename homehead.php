  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
     <ul class="nav navbar-nav navbar-right">
              ...
              <li><a href="register.php"><img src="icons/add-user-male.png"/>Register&nbsp</a></li>

        <li><a href="sindex.php"><img src="icons/user1.png"/>User Sign In&nbsp</a></li>

        <li><a href="adminindex.php"><img src="icons/admin-settings-male.png"/>Admin Sign In&nbsp</a></li>
